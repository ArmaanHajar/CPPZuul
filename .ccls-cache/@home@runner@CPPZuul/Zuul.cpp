...
int main() {
  ...
  strncpy(roomDescription,
          "The Whole State Is A Desert, Wouldn't It Be Nice If There Were More "
          "Trees Here?",
          199);
  ...
  strncpy(roomDescription,
          "The Second Driest State in the United States, Wouldn't It Be Nice "
          "If It Rained Here?",
          199);
  ...
  strncpy(roomDescription,
          "Avoid Speaking With The Locals, Also, Why Is It So Hot Here?", 199);
  Room *arizona = new Room(roomName, roomDescription);

  strncpy(roomName, "North Dakota", 79);
  strncpy(roomDescription,
          "The Definition of Midwest, You're Pretty Much In Canada Right Now",
          199);
  ...
  strncpy(roomDescription,
          "The Colorado Population Is Majority Tourists Who Enjoy Skiing", 199);
  ...
  bool gameWon = false;
  cout << "Welcome to the Mid-West Coast Zuul! Your job is to make it rain in "
          "Arizona and to bring trees to Nevada!"
       << endl;
  while (gameWon == false) {
    cout << "You are in: " << currentRoom << endl;
    cout << "The items in this room are: " << currentRoom->printItems() << endl;
    cout << "The exits are: " << currentRoom->printExits() << endl;
    cout << "---------------------------------------------------------" << endl;
